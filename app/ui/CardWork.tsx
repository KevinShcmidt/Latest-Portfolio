...
export default function CardWork({
  ...
  return (
    <div className="bg-[#e5e5e5] w-full h-96 rounded-2xl flex flex-col gap-4 items-center justify-start hover:scale-105 transition-transform duration-300 group">
      ...
      <div className="text-[#14213d] p-4 flex flex-col flex-1 w-full">
