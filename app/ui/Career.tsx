  ...
  return (
    <div className="mt-10 md:mt-16 mx-6">
      ...
      <div className="w-full relative grid grid-cols-1 place-items-start md:place-items-center">
        ...
        <div className="absolute ml-[2px] top-[304px] md:top-[296px]">
          <Rounde />
        </div>
        <div className="absolute ml-[2px] top-[536px] md:top-[528px]">
          <Rounde />
        </div>
        <div className="absolute ml-[2px] top-[768px] md:top-[760px]">
          <Rounde />
        </div>
        <div className="absolute top-6 grid grid-cols-1 md:grid-cols-2 grid-rows-4 gap-y-2 md:gap-y-0 gap-x-12 p-6">
          <div className="w-full col-start-1 md:col-start-2 row-start-1 ">
            <CardBackGround
              date="JAN 2025 - NOW"
              position="start"
          ...
          <div className="w-full col-start-1 row-start-2 ">
            <CardBackGround
          ...
          <div className="w-full col-start-1 md:col-start-2 row-start-3 ">
            <CardBackGround
              date="2023"
              position="start"
          ...
          <div className="w-full col-start-1 row-start-4 ">
            <CardBackGround
              date="(1 Week in 2023)"
              position="start"
